...
export default function Checkout(): JSX.Element {
  ...
  const formik = useFormik<CheckoutValues>({
    ...
    validationSchema,
    onSubmit: (values) => handleCheckout(cartId ?? "", window.location.origin, values),
  });

  async function handleCheckout(cartIdParam: string, url: string, values: CheckoutValues): Promise<void> {
    if (!cartIdParam) {
      ...
      <form onSubmit={formik.handleSubmit} className="max-w-md mx-auto">
        <div className="relative z-0 w-full mb-5 group">
          <input
            ...
            placeholder=" "
          />
          <label htmlFor="details" className="absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10">
            Details
          </label>
        ...
        <div className="relative z-0 w-full mb-5 group">
          <input
            ...
            placeholder=" "
          />
          <label htmlFor="phone" className="absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10">
            Phone
          </label>
        ...
        <div className="relative z-0 w-full mb-5 group">
          <input
            ...
            placeholder=" "
          />
          <label htmlFor="city" className="absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10">
            City
          </label>
